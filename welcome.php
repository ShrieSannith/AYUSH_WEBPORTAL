...
// Fetch user information from the database based on the logged-in user's ID
$userID = $_SESSION['U_ID'];
$query = "SELECT User_Name, Email, Phone_Number, Role FROM users WHERE U_ID = '$userID'";
...
<?php endif; ?> 
    ...
    <div class="s-12 l-6 center">
        <img src="img/1.png" alt="About Ayush Image" class="image-right">
